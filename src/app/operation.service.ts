...
export class OperationService {
  ...
  public updateOperation(operation: Operation): Observable<Operation> {
    return this.http.put<Operation>(`${this.apiServerUrl}/operation/update`, operation);
  }

  public deleteOperation(operationId: number): Observable<Operation> {
    return this.http.delete<Operation>(`${this.apiServerUrl}/operation/delete/${operationId}`);
  }
}
